...
describe('DigitalDataEnricher', () => {
  ...
  describe('#enrichContextData', () => {
    ...
    it('should enrich DDL context campaign variable', () => {
      ...
      _digitalDataEnricher.setDDStorage(_ddStorage)
      _digitalDataEnricher.enrichContextData()
      assert.strict.deepEqual(_digitalData.context.campaign, {
        name: 'test_campaign',
        source: 'newsletter',
        medium: 'email'
      })
  ...
  describe('#enrichContextData', () => {
    it('should enrich DDL context campaign variable for gclid', () => {
      ...
      assert.strict.deepEqual(__digitalData.context.campaign, {
        source: 'google',
        medium: 'cpc'
      })
    })
  ...
  describe('#enrichDDStorageData', () => {
    it('should enrich data from local storage', () => {
      ...
      assert.strict.deepEqual(_digitalData.user, {
        userId: '123',
  ...
  describe('default enrichments', () => {
    ...
    it('should enrich user data', () => {
      ...
      assert.strict.equal(_digitalData.user.email, 'test@email.com')
      assert.strict.equal(_digitalData.user.lastTransactionDate, '2016-03-30T10:05:26.041Z')
    })
