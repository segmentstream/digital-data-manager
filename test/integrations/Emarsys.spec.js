  ...
  describe('before loading', () => {
    ...
    describe('#constructor', () => {
      it('should add proper tags and options', () => {
        assert.strict.equal(options.merchantId, emarsys.getOption('merchantId'))
        assert.strict.equal('script', emarsys.getTag().type)
        assert.strict.equal(emarsys.getTag().attr.src,
