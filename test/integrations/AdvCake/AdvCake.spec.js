    ...
    describe('#onViewedPage', () => {
      it('should track home page, cart and authorized user', () => {
        ...
        window.digitalData.events.push({
          ...
          cart: cartStub,
          callback: () => {
            assert.deepEqual(window.advcake_data, onViewedHomePageAuthorizedStub);
          },
        });
      });
      ...
      it('should track home page, cart and unauthorized user', () => {
        ...
        window.digitalData.events.push({
          ...
          cart: cartStub,
          callback: () => {
            assert.deepEqual(window.advcake_data, onViewedHomePageUnauthorizedStub);
          },
        });
      });
    });
    ...
    describe('#onViewedProductPage', () => {
      ...
      it('should track product page', () => {
        ...
        window.digitalData.events.push({
          ...
          callback: () => {
            assert.deepEqual(window.advcake_data, onViewedProductPageStub.out);
          },
        });
      });
    });
    ...
    describe('#onViewedProductListing', () => {
      ...
      it('should track product listing page', () => {
        ...
        window.digitalData.events.push({
          ...
          callback: () => {
            assert.deepEqual(window.advcake_data, onViewedListingPageStub.out);
          },
        });
      });
    });
    ...
    describe('#onViewedCart', () => {
      ...
      it('should track cart page', () => {
        ...
        window.digitalData.events.push({
          name: 'Viewed Cart',
          callback: () => {
            assert.deepEqual(window.advcake_data, onViewedCartPageStub);
          },
        });
      });
    });
    ...
    describe('#onCompletedTransaction', () => {
      ...
      it('should track completed transaction with default deduplication', (done) => {
        ...
        window.digitalData.events.push({
          ...
          callback: () => {
            assert.deepEqual(window.advcake_data, onCompletedTransactionStub.out);
            done();
          },
        });
