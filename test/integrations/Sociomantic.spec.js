  ...
  describe('before loading', () => {
    describe('#constructor', () => {
      it('should add options', () => {
        assert.strict.equal(options.region, sociomantic.getOption('region'))
        assert.strict.equal(options.advertiserToken, sociomantic.getOption('advertiserToken'))
        assert.strict.equal(options.prefix, sociomantic.getOption('prefix'))
      })
    })
  })
    ...
    describe('#onViewedPage', () => {
      ...
      it('should set customer object if user visits any pages', (done) => {
        window.digitalData.events.push({
          ...
          callback: () => {
            setTimeout(() => {
              assert.strict.deepEqual(window[options.prefix + 'customer'], { identifier: '55123' })
        ...
        window.digitalData.events.push({
          ...
          callback: () => {
            setTimeout(() => {
              ...
              assert.strict.equal(window[options.prefix + 'customer'].mhash, hash)
              assert.ok(sociomantic.loadTrackingScript.calledOnce)
              done()
            }, 150)
          }
    ...
    describe('#onViewedProductDetail', () => {
      ...
      it('should set product object if user visits product detail page', (done) => {
        window.digitalData.events.push({
          ...
          callback: () => {
            assert.strict.deepEqual(window[options.prefix + 'product'], { identifier: '123' })
            assert.ok(sociomantic.loadTrackingScript.calledOnce)
            done()
          }
        })
    ...
    describe('#onViewedProductListing', () => {
      ...
      it('should set global product object if user visits product category page', (done) => {
        window.digitalData.events.push({
          ...
          callback: () => {
            assert.strict.deepEqual(window[options.prefix + 'product'], { category: [ 'shoes', 'female' ] })
            assert.ok(sociomantic.loadTrackingScript.calledOnce)
            done()
          }
        })
    ...
    describe('#onSearchedProducts', () => {
      ...
      it('should set global search object if user search products', (done) => {
        window.digitalData.events.push({
          ...
          callback: () => {
            assert.strict.deepEqual(window[options.prefix + 'search'], {
              query: 'test query',
              type: 2
            })
            assert.ok(sociomantic.loadTrackingScript.calledOnce)
        ...
        window.digitalData.events.push({
          ...
          callback: () => {
            window.digitalData.events.push({
              ...
              callback: () => {
                setTimeout(() => {
                  assert.strict.deepEqual(window[options.prefix + 'basket'], {
                    products: [
