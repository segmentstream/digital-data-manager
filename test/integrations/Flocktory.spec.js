  ...
  describe('before loading', () => {
    ...
    describe('#constructor', () => {
      it('should add proper tags and options', () => {
        assert.equal(options.siteId, flocktory.getOption('siteId'));
        assert.equal('script', flocktory.getTag().type);
        assert.equal(flocktory.getTag().attr.src, `https://api.flocktory.com/v2/loader.js?site_id=${options.siteId}`);
      });
    });
