  ...
  describe('before loading', () => {
    ...
    describe('#constructor', () => {
      it('should add proper tags and options', () => {
        assert.strict.equal(options.conversionId, adwords.getOption('conversionId'))
        assert.strict.equal('script', adwords.getTag().type)
        assert.strict.equal(adwords.getTag().attr.src, '//www.googleadservices.com/pagead/conversion_async.js')
      })
    })
