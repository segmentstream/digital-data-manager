...
class Filters {
  ...
  filterTransaction (transaction = {}) {
    return filterObject({
      ...transaction,
      isFirst: typeof transaction.isFirst === 'boolean' ? transaction.isFirst : undefined,
  ...
  filterCommonEvent (event) {
    ...
    return cleanObject({
      ...
      nonInteraction: typeof event.nonInteraction === 'boolean' ? event.nonInteraction : undefined,
